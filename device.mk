...
# Inherit from vendor tree (contains proprietary blobs)
...
# Init files from stock ROM dump
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init/hw/init.x6886.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.x6886.rc \
...
# Config files from stock ROM dump
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/bluetooth_audio_policy.xml:$(TARGET_COPY_OUT_VENDOR)/etc/bluetooth_audio_policy.xml \
    $(LOCAL_PATH)/configs/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml \
    $(LOCAL_PATH)/configs/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles.xml \
    $(LOCAL_PATH)/configs/p2p_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/p2p_supplicant_overlay.conf \
    $(LOCAL_PATH)/configs/wpa_supplicant.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wpa_supplicant.conf \
    $(LOCAL_PATH)/configs/wpa_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wpa_supplicant_overlay.conf
